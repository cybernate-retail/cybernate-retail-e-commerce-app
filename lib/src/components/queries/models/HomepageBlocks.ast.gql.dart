...
const HomepageBlocksQuery = _i1.OperationDefinitionNode(
  type: _i1.OperationType.query,
  name: _i1.NameNode(value: 'HomepageBlocksQuery'),
  variableDefinitions: [
        ...
        _i1.FieldNode(
          ...
          selectionSet: _i1.SelectionSetNode(selections: [
            _i1.FragmentSpreadNode(
              name: _i1.NameNode(value: 'HomepageBlockFragment'),
              directives: [],
            )
          ]),
        ),
