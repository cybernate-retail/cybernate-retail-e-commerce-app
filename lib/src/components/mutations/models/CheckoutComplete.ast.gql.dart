...
const checkoutComplete = _i1.OperationDefinitionNode(
  ...
  variableDefinitions: [
    ...
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(name: _i1.NameNode(value: 'paymentData')),
      type: _i1.NamedTypeNode(
    ...
    _i1.FieldNode(
      ...
      arguments: [
        ...
        _i1.ArgumentNode(
          ...
          value: _i1.VariableNode(name: _i1.NameNode(value: 'paymentData')),
        ),
      ],
      directives: [],
      selectionSet: _i1.SelectionSetNode(selections: [
