...
const RemoveProductFromCheckout = _i1.OperationDefinitionNode(
  type: _i1.OperationType.mutation,
  name: _i1.NameNode(value: 'RemoveProductFromCheckout'),
  variableDefinitions: [
    ...
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(name: _i1.NameNode(value: 'lineId')),
      type: _i1.NamedTypeNode(
    ...
    _i1.FieldNode(
      ...
      arguments: [
        ...
        _i1.ArgumentNode(
          ...
          value: _i1.VariableNode(name: _i1.NameNode(value: 'lineId')),
        ),
      ],
      directives: [],
      selectionSet: _i1.SelectionSetNode(selections: [
